    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center px-6 text-center">
        ...
        <button
          ...
          className="mt-8 rounded-full border border-[#8edcff]/35 bg-[#0b3b43]/55 px-6 py-3 text-sm font-semibold text-white backdrop-blur-md transition hover:border-[#53d6f7] hover:bg-[#1ec7f3] hover:text-slate-950"
        >
          Back to My Trips
        </button>
      </div>
