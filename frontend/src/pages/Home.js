    ...
    <div className="min-h-screen bg-[#062f35]">
      ...
      <div className="relative overflow-hidden bg-[linear-gradient(180deg,#08353d_0%,#062f35_100%)]">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(30,199,243,0.18),transparent_30%),radial-gradient(circle_at_15%_40%,rgba(255,255,255,0.08),transparent_22%),radial-gradient(circle_at_70%_85%,rgba(30,199,243,0.12),transparent_25%)]" />
        </div>
