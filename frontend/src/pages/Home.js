      ...
      <div className="relative overflow-hidden bg-[linear-gradient(180deg,#08353d_0%,#062f35_100%)]">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-8 pt-2 sm:px-10 lg:px-12">
          ...
          <section className="mt-6">
            <UserReviewsShowcase
              title="Real reactions from TripWise travelers"
              eyebrow="Planner trust"
              description="Public reviews help new travelers see who shares thoughtful trips, smooth itineraries, and helpful planning ideas."
              limit={3}
            />
          </section>
        </div>
