...
import MyTripsCarousel from "./MyTripsCarousel.jsx";
...
const HeroSection = () => {
  return (
    <section className="relative min-h-[1480px] overflow-hidden bg-[#062f35]">
      ...
      />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(4,24,31,0.18)_0%,rgba(4,24,31,0.3)_24%,rgba(4,24,31,0.6)_56%,rgba(4,24,31,0.88)_100%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.08),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(7,190,210,0.16),transparent_30%),linear-gradient(90deg,rgba(4,24,31,0.16),transparent_36%,rgba(4,24,31,0.22)_100%)]" />
