          ...
          {(mode === "upcoming" || mode === "completed") ? (
            <>
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-slate-700">
                  {new Date(trip.updatedAt || trip.createdAt || new Date()).toLocaleDateString()}
                </p>
              </div>
            </>
          ) : (
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          {mode === "upcoming" && (
            <>
               ...
               <button
                 type="button"
                 onClick={() => onMarkCompleted?.(trip)}
                 className="rounded-full border border-sky-300/35 bg-sky-900/40 px-5 py-3 text-sm font-semibold text-sky-200 backdrop-blur-md transition hover:border-sky-400 hover:bg-sky-600/50 hover:text-white"
               >
                 Mark as Completed
               </button>
            </>
