  ...
  return (
    <section className="relative isolate overflow-x-hidden px-4 py-8 sm:px-6 lg:px-10">
      ...
      <img
        ...
        className="pointer-events-none absolute inset-0 h-full w-full object-cover brightness-[0.4] contrast-125"
      />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,rgba(4,19,24,0.5),rgba(4,19,24,0.85))]" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(77,212,255,0.15),transparent_40%),radial-gradient(circle_at_bottom_left,rgba(77,212,255,0.1),transparent_40%)]" />
      <div className="pointer-events-none absolute inset-0 opacity-10 [background-image:radial-gradient(#ffffff_1px,transparent_1px)] [background-size:32px_32px]" />
